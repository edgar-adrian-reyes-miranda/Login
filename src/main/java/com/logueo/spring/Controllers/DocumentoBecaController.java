...
public class DocumentoBecaController {
    ...
    public List<DocumentoBeca> obtenertodos(){
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<?> consultardocumentobecaPorID(@PathVariable Long id){
    ...
    public ResponseEntity<?> creardocumento(@RequestBody DocumentoBecaDto documentoBecaDto) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> eliminardocumenot(@PathVariable Long id) {
        Map<String, Object> response = new HashMap<>();
    ...
    public ResponseEntity<?> editardocumento(@PathVariable Long id, @RequestBody DocumentoBecaDto documentoBecaDto) {
